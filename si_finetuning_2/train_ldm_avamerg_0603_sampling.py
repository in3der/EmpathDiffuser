...
class MultimodalLoss:
    ...
    def compute_loss(img_latent: torch.Tensor,
        ...
        data_type = torch.randint(2, 3, (img_latent.size(0),), device=img_latent.device)
        ...
        loss_clip = MultimodalLoss._mean_squared_error(eps_clip - pred_clip)
    ...
    def setup_logging(self) -> None:
        ...
        if self.accelerator.is_main_process:
            ...
            logging.basicConfig(
                ...
                handlers=[
                    logging.FileHandler('wandb/training.log'),
        ...
        while step < config.train.n_steps:
            for batch in data_loader:
                ...
                if trainer.accelerator.is_main_process and step % config.train.log_interval == 0:
                    ...
                    metrics['step'] = step
                    logging.info(f"Step {step}: Loss={metrics['loss']:.6f}, LR={metrics['lr']:.6f}")
